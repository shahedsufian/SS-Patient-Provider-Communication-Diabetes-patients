...
... for the MEPS diabetes cohort data. It is designed to replace the original R and
... Stata scripts by consolidating the entire workflow into a single, efficient,
... and well-documented Python program.
... 
